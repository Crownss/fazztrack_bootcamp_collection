            ...
            <>
                <div className="bg-no-repeat bg-auto" style={{backgroundImage:`url("/img/login.png")`}}>
                    <div className="flex">
                        ...
                        <div className="mt-12"></div>
                        <button type="submit" className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-20 border border-blue-700 rounded">Login</button>
                        <br />
                        <div className="mt-5"></div>
                        <button type="submit" className="bg-white-500 font-bold py-2 px-8 border rounded"><FontAwesomeIcon icon={faGoogle}/> Login with google</button>
                        </form>
                        </div>
                        </div>
                </div>
