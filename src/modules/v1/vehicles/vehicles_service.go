...
func (vehicles *vehicles_service) Delete_Vehicles(id int) (*gorm.DB, error) {
	data, err := vehicles.repo.Delete(id)
	if err != nil {
		return nil, err
	}
	return data, nil
...
func (vehicles *vehicles_service) Get(id int) (*models.Vehicles, error) {
	data_vehicles, err := vehicles.repo.Find(id)
	if err != nil {
		return nil, err
	}
...
func (vehicles *vehicles_service) Update_Vehicles(id int, data *models.Vehicles) (*models.Vehicles, error) {
	data, err := vehicles.repo.Update(id, data)
	if err != nil {
		return nil, err
	}
